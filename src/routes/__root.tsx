...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "ScamLens AI by Zain Abuzaid" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ScamLens AI by Zain Abuzaid | Cybersecurity Analysis" },
      { name: "twitter:description", content: "AI-assisted cybersecurity analysis by Zain Abuzaid." },
      { name: "twitter:site", content: "@ScamLensAI" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "icon", href: "/scamlens/logo.svg", type: "image/svg+xml" },
      { rel: "apple-touch-icon", href: "/scamlens/logo.svg" },
    ],
  }),
